# CIDAtools [![](reference/figures/CIDAtoolshex.png)](https://cida-csph.github.io/CIDAtools)
...
This package contains numerous templates and tools to make life at CIDA
...
[`?create_project`](https://cida-csph.github.io/CIDAtools/reference/create_project.md)
for more details. If any of these are specified, they are stored as text
in a hidden subdirectory called .ProjData, and can be called in
subsequent R code anywhere in the project using
[`ProjectName()`](https://cida-csph.github.io/CIDAtools/reference/ProjectName.md),
[`ProjectPI()`](https://cida-csph.github.io/CIDAtools/reference/ProjectPI.md),
and
[`ProjectAnalyst()`](https://cida-csph.github.io/CIDAtools/reference/ProjectAnalyst.md).
