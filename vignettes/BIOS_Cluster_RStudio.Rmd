...
Although you can pass parameters to SSH when calling `ssh` on the command line, the simplest way to configure SSH options is to use the SSH config file.
...
This article covers the basic use of the RStudio and JupyterLab on the cluster. For advanced topics, see [Additional Options for RStudio/JupyterLab on the CSPH Biostats Cluster](https://cida-csph.github.io/CIDAtools/articles/BIOS_Cluster_RStudio_Advanced.html)