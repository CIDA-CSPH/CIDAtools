...
fig0A <- system.file("figures", "figure0A.png", package="CIDAtools")
fig0C <- system.file("figures", "figure0C.png", package="CIDAtools")
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure1A.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "figure1B.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "figure1C.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "figure2A.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "figure2B.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "figure2C.png", package="CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure3A.png", package = "CIDAtools"))
knitr::include_graphics(system.file("figures", "figure3B.png", package = "CIDAtools"))
knitr::include_graphics(system.file("figures", "figure3C.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure4A.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure4B.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure4C.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure4D.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "figure5A.png", package = "CIDAtools"))
```
