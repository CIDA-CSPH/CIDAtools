...
fig0A <- system.file("figures", "gitkraken/figure0A.png", package="CIDAtools")
fig0C <- system.file("figures", "gitkraken/figure0C.png", package="CIDAtools")

knitr::include_graphics(fig0A)
knitr::include_graphics(fig0C)
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure1A.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure1B.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure1C.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure2A.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure2B.png", package="CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure2C.png", package="CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure3A.png", package = "CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure3B.png", package = "CIDAtools"))
knitr::include_graphics(system.file("figures", "gitkraken/figure3C.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure4A.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure4B.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure4C.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure4D.png", package = "CIDAtools"))
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics(system.file("figures", "gitkraken/figure5A.png", package = "CIDAtools"))
```
