...
Should I even then have a version of my code on the P: drive at all?  - It’s up to you 

- If I do, and I pull from GitHub/Lab, am I replacing the code on the P: drive?  - Yes, but only if something’s changed on the GitHub server. You can also easily “checkout” earlier versions of the repository from previous points in time, so the older code is never lost. 
