...
knitr::include_graphics("git_figures/sph_cida_wm_blk.png")
```
...
knitr::include_graphics("git_figures/figure0A.png")
knitr::include_graphics("git_figures/figure0C.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure1A.png")
knitr::include_graphics("git_figures/figure1B.png")
knitr::include_graphics("git_figures/figure1C.png")
knitr::include_graphics("git_figures/figure2A.png")
knitr::include_graphics("git_figures/figure2B.png")
knitr::include_graphics("git_figures/figure2C.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure3A.png")
knitr::include_graphics("git_figures/figure3B.png")
knitr::include_graphics("git_figures/figure3C.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure4A.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure4B.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure4C.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure4D.png")
```
...
```{r, echo=FALSE, out.width="100%", out.height="100%"}
knitr::include_graphics("git_figures/figure5A.png")
```
