...
5.  [(Optional) Additional Options](#optional-additional-options-and-job-customization) - Some additional options and information which may be useful.
...
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_ssh_2.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/localhost_test.png")
```

Moving back to your SSH window, you should see some error messages populate the screen:

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_ssh_local_forward_test.png")
```
...
## 2. Launching an RStudio Session {#launching-an-rstudio-session}
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_rstudio_launch.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_rstudio_interface.png")
```
...
3.  Run `squeue` again and verify that your job is still running. If the job is not running, check `rstudio_helper.err` and `rstudio_helper.out` for more information.
...
## 3. Launching a JupyterLab Session {#launching-a-jupyterlab-session}
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_jupyter_launch.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_jupyter_interface.png")
```
...
## 4. Quit the RStudio/JupyterLab Session {#quit-the-rstudiojupyterlab-session}
...
## 5. Quickstart (for returning users) {#quickstart-for-returning-users}
...
## 7. (Optional) Additional Options and Job Customization {#optional-additional-options-and-job-customization}
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("figures/CIDA_BC_IDEs/biostats_hpc_rstudio_diagram.png")
```
