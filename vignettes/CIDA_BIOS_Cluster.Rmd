...
knitr::include_graphics("HPC_images/cluster_basic_diagram.png")
```
...
knitr::include_graphics("HPC_images/Biostats_HPC_diagram.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("HPC_images/biostats_hpc_ssh.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("HPC_images/cyberduck_1.png")
```

Next, ensure that the 'SFTP' option is selected in the dropdown, then input your SSH credentials.

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("HPC_images/cyberduck_2.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("HPC_images/cyberduck_3.png")
```
