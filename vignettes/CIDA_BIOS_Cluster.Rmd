...
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cluster_basic_diagram.png")
```
...
knitr::include_graphics("CIDA_BIOS_Cluster_figures/Biostats_HPC_diagram.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/biostats_hpc_ssh.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cluster_sbatch.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cluster_srun.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/interactive_job.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cyberduck_1.png")
```

Next, ensure that the 'SFTP' option is selected in the dropdown, then input your SSH credentials.

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cyberduck_2.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_figures/cyberduck_3.png")
```
