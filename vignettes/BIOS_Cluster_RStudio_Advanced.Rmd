...
The RStudio and JupyterLab containers are derived from a base container which holds installation of R, Python, and Julia languages, along with packages/libraries to support installing most other common R/Python libraries.
...
To change the version of R used when launching RStudio, you can modify the `rstudio_helper.sh` script:
