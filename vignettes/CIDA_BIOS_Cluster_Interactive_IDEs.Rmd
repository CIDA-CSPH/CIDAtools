...
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_ssh_2.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/localhost_test.png")
```

Moving back to your SSH window, you should see some error messages populate the screen:

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_ssh_local_forward_test.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_launch.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_interface.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_jupyter_launch.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_jupyter_interface.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("CIDA_BIOS_Cluster_Interactive_IDEs_figures/biostats_hpc_rstudio_diagram.png")
```
